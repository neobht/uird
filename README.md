...
**UIRD** - это разновидность _initrd_, его задача собрать из слоев _aufs_ корневую файловую систему и передать загрузку `/sbin/init (systemd)` с этой корневой файловой системой.
